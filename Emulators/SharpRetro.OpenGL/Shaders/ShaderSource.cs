...
namespace SharpRetro.OpenGL.Shaders
{
  public class ShaderSource : IDisposable
  {
    public const string VERTEX_SHADER_RESOURCE = "SharpRetro.OpenGL.Shaders.DefaultVertexShader.glsl";
    public const string FRAGMENT_SHADER_RESOURCE = "SharpRetro.OpenGL.Shaders.DefaultFragmentShader.glsl";
