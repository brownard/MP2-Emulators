...
{
  /// <summary>
  /// Unimplemented: The idea is that this class will monitor the jitter of the system's audio renderer using the biquad filter
  /// and adjust the audio playback speed accordingly to allow the audio playback to match the target framerate exactly.
  /// </summary>
  class SoundBufferMonitor
  {
  }
